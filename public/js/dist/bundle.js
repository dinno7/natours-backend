...
function showAlert(msg) {
  ...
  removeAlert();
  var alertTag = "<div class=\"alert alert--".concat(type, "\">").concat(msg, "</div>");
  document.querySelector('body').insertAdjacentHTML('afterbegin', alertTag);
  removeAlert(5000);
}
function removeAlert() {
  var timeout = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
  var alertTag = document.querySelector('.alert');
  setInterval(function () {
    if (alertTag && alertTag !== null && alertTag !== void 0 && alertTag.parentElement) alertTag.parentElement.removeChild(alertTag);
  }, timeout);
}
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (data.ok) {
            (0, _alert.default)('You logged in successfully.', 'success');
            setTimeout(function () {
        ...
        case 8:
          ...
          (0, _alert.default)(_context.t0.response.data.message, 'error');
        case 11:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          ...
          return _context2.abrupt("return", location.pathname = '/');
        case 8:
          return _context2.abrupt("return", (0, _alert.default)('Logout successfully', 'info'));
        case 9:
          _context2.next = 14;
          break;
        case 11:
          ...
          return _context2.abrupt("return", (0, _alert.default)(_context2.t0.response.data.message, 'error'));
        case 14:
        case "end":
...
function _updateUser() {
  _updateUser = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data) {
    var readableData, res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          readableData = Object.fromEntries(data);
        ...
        case 5:
          res = _context.sent;
          if (res.data.ok) {
            (0, _alert.default)('Updated successfully', 'success');
            setTimeout(function () {
        ...
        case 9:
          _context.prev = 9;
          _context.t0 = _context["catch"](0);
          return _context.abrupt("return", (0, _alert.default)(_context.t0.response.data.message, 'error'));
        case 12:
        case "end":
          return _context.stop();
      }
...
function _updateUserPassword() {
  _updateUserPassword = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var currentPassword,
      newPassword,
      newPasswordConfirm,
      res,
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          currentPassword = _args2.length > 0 && _args2[0] !== undefined ? _args2[0] : '';
          newPassword = _args2.length > 1 && _args2[1] !== undefined ? _args2[1] : '';
          newPasswordConfirm = _args2.length > 2 && _args2[2] !== undefined ? _args2[2] : '';
          if (!(!currentPassword || !newPassword || !newPasswordConfirm)) {
            _context2.next = 5;
            break;
          }
          return _context2.abrupt("return", (0, _alert.default)('Please provide all password fields', 'error'));
        case 5:
          if (!(newPassword !== newPasswordConfirm)) {
            _context2.next = 7;
            break;
          }
          return _context2.abrupt("return", (0, _alert.default)('New password and confirm must be same', 'error'));
        case 7:
          _context2.prev = 7;
          _context2.next = 10;
        ...
        case 10:
          ...
          return _context2.abrupt("return", (0, _alert.default)('Your password changed successfully', 'success'));
        case 13:
...
window.addEventListener('load', function (e) {
  ...
  var updateUserForm = document.querySelector('form.form-user-data');
  var updateUserPasswordForm = document.querySelector('form.form-user-password');
  ...
  if (updateUserForm) updateUserForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(e) {
      var _Object$fromEntries, name, email, photo, form;
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            e.preventDefault();
            _Object$fromEntries = Object.fromEntries(new FormData(this)), name = _Object$fromEntries.name, email = _Object$fromEntries.email, photo = _Object$fromEntries.photo;
            form = new FormData();
            form.append('name', name);
            form.append('email', email);
            form.append('photo', photo);
            _context3.next = 8;
            return (0, _updateSettings.updateUser)(form);
          case 8:
          case "end":
  ...
  // >> ---------------------
  if (updateUserPasswordForm) updateUserPasswordForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(e) {
      var formData, _formData, currentPassword, newPassword, newPasswordConfirm;
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _formData = formData, currentPassword = _formData.currentPassword, newPassword = _formData.newPassword, newPasswordConfirm = _formData.newPasswordConfirm;
            _context4.next = 6;
            return (0, _updateSettings.updateUserPassword)(currentPassword, newPassword, newPasswordConfirm);
          case 6:
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "42627" + '/');
